...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, CharSelect, Tutorial, PlayPage):
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        controller.title("Space Blues")
        controller.geometry("300x200")

        label = tk.Label(self, text="Space Blues", font=controller.title_font)
        label.pack(side="top", fill="x", pady=10)

        button1 = tk.Button(self, text="Play", width=25,
                            command=lambda: controller.show_frame("CharSelect"))
        button2 = tk.Button(self, text="How to Play", width=25,
                            command=lambda: controller.show_frame("Tutorial"))
        button3 = tk.Button(self, text="Quit", width=25,
